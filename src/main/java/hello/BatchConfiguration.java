...
public class BatchConfiguration {
    ...
    @Bean
    public FlatFileItemWriter<Person> errorItemWriter() {
    ...
    @Bean
    public SkipListener skipListener(FlatFileItemWriter<Person> errorItemWriter) {
        return new SkipListener(errorItemWriter);
    }

    @Bean
    public Step step1(JdbcBatchItemWriter<Person> writer, ChunkListener chunkListener, SkipListener skipListner, FlatFileItemWriter<Person> errorItemWriter) {
